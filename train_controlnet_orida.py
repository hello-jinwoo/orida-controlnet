...
def log_validation(
    ...
    for validation_src_image, validation_tgt_image in zip(validation_src_images, validation_tgt_images):
        ...
        for _ in range(args.num_validation_images):
            ...
            # TODO: [Important] Validation inference pipeline
            images.append(image)
...
def make_train_dataset(args, tokenizer, accelerator):
    ...
    def preprocess_train(examples):
        ...
        for i in range(bs):
            ...
            src_obj_mask = Image.open(examples["src_obj_mask_path"][i]).convert("RGB").resize((img_len, img_len))
            ...
            if len(os.listdir("/workspace/diffusers/examples/controlnet/train_data_samples")) < 100: # TODO: delete this
                filename_tmp = examples["bg_img_path"][i].split("/")[-1].split(".jpg")[0]
                in_img.save(f"train_data_samples/{filename_tmp}_input.jpg")
                tgt_img.save(f"train_data_samples/{filename_tmp}_output.jpg")
